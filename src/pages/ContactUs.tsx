      ...
      >
        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <p className="text-gray-600 mb-6">Have a question, feedback or want to work together? Send us a message and we'll get back to you within 1-2 business days.</p>
